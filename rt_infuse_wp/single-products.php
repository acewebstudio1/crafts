																					...
																					<div <?php post_class();?> id="post-<?php the_ID();?>">
																						...
																						<div class="main-content">
																							<div class="post-content">
							    																...
							    																// $url = 'https://www.yourcraftsfair.com/store/#!/~/product/category=5073653&id=22015156';
                                            ...
                                            <form>
                                              <div style='text-align: center'>
                                                <!-- Ecwid code. Please do not remove this line otherwise your Ecwid shopping cart will not work properly. -->
                                                    <?php echo ecwid_minicart_shortcode(); ?>
                                                <!-- Ecwid code end -->

                                                <!--<script type="text/javascript" src="http://app.ecwid.com/script.js?<?php print $ecwidStoreId; ?>" charset="utf-8"></script>
                                                <script type="text/javascript">xAddToBag('productid=<?php print $prodArray->id; ?>');</script>-->
                                              </div>
                                            </form>
                                          </div>
                                        </div>
