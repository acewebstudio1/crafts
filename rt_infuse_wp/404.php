      ...
      <div class="main-r">
        <div id="main-body">
          <div id="main-content" class="<?php echo $option['layout_subpage']; ?>">
            <div class=
            "colmask leftmenu&lt;?php if (rok_isIe(6)) echo ' wrapper'; ?&gt;">
              <?php if (!rok_isIe(6)):?>
                        ...
                        <div class="col1">
                          <div id="maincol">
                            ...
                            <div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
                                    ...
                                    <div class="attention">
                                      <div class="icon">
                                        <?php _re('Sorry, this page does not exist on this site');                                   
                                        ?>
                                      </div>
                      
                                    </div>
                                    
                                    <h4>You might be interested in the following:</h4>
                                    <div class="menu-404"> 
                                    <?php  wp_nav_menu('browse'); ?>
                                    </div>
