				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="breadcrumbs"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[breadcrumbs]" id="breadcrumbs" <?php if($option['breadcrumbs'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="ie_warning"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[ie_warning]" id="ie_warning" <?php if($option['ie_warning'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck doublefield">
								<div>
									<input class="textbox" id="thumb_width" type="text" size="3" maxlength="255" name="infuse-options[thumb_width]" value="<?php echo $option['thumb_width']; ?>" />
									<span style="margin-left:8px; line-height: 20px;">x</span>
									<input class="textbox" id="thumb_height" type="text" size="3" maxlength="255" name="infuse-options[thumb_height]" value="<?php echo $option['thumb_height']; ?>" />
                   				</div>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="search_box"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[search_box]" id="search_box" <?php if($option['search_box'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="site_logo"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[site_logo]" id="site_logo" <?php if($option['site_logo'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="footer_backtop"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[footer_backtop]" id="footer_backtop" <?php if($option['footer_backtop'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="footer_logo"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[footer_logo]" id="footer_logo" <?php if($option['footer_logo'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="footer_copyright_text">
									<input class="textbox" id="footer_copyright_text" type="text" size="15" maxlength="255" name="infuse-options[footer_copyright_text]" value="<?php echo $option['footer_copyright_text']; ?>" />
                   				</label>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="footer_copyright"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[footer_copyright]" id="footer_copyright" <?php if($option['footer_copyright'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="blog_order">
									<select id="blog_order" name="infuse-options[blog_order]">
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="blog_content">
									<select id="blog_content" name="infuse-options[blog_content]">
				...
				<tr>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="blog_cat">
									<input class="textbox" id="blog_cat" type="text" size="15" maxlength="255" name="infuse-options[blog_cat]" value="<?php echo $option['blog_cat']; ?>" />
                   				</label>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="blog_title"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[blog_title]" id="blog_title" <?php if($option['blog_title'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="blog_title_link"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[blog_title_link]" id="blog_title_link" <?php if($option['blog_title_link'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="blog_meta"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[blog_meta]" id="blog_meta" <?php if($option['blog_meta'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="blog_author"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[blog_author]" id="blog_author" <?php if($option['blog_author'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="blog_date"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[blog_date]" id="blog_date" <?php if($option['blog_date'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="top_blogroll"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[top_blogroll]" id="top_blogroll" <?php if($option['top_blogroll'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="top_blogroll_order">
									<select id="top_blogroll_order" name="infuse-options[top_blogroll_order]">
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="top_blogroll_limit">
									<input class="textbox" id="top_blogroll_limit" type="text" size="3" maxlength="255" name="infuse-options[top_blogroll_limit]" value="<?php echo $option['top_blogroll_limit']; ?>" />
                   				</label>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="top_blogroll_category">
									<input class="textbox" id="top_blogroll_category" type="text" size="3" maxlength="255" name="infuse-options[top_blogroll_category]" value="<?php echo $option['top_blogroll_category']; ?>" />
                   				</label>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="footer_enabled"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[footer_enabled]" id="footer_enabled" <?php if($option['footer_enabled'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="footer_order">
									<select id="footer_order" name="infuse-options[footer_order]">
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="footer_cat">
									<?php wp_dropdown_categories('show_option_none=None&hide_empty=0&name=infuse-options[footer_cat]&exclude=1&orderby=name&selected='.$option['footer_cat']); ?>
      			     			</label>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="footer_post_count">
									<input class="textbox" id="footer_post_count" type="text" size="3" maxlength="255" name="infuse-options[footer_post_count]" value="<?php echo $option['footer_post_count']; ?>" />
                   				</label>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="footer_popular_enabled"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[footer_popular_enabled]" id="footer_popular_enabled" <?php if($option['footer_popular_enabled'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="footer_recent_enabled"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[footer_recent_enabled]" id="footer_recent_enabled" <?php if($option['footer_recent_enabled'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="footer_modified_enabled"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[footer_modified_enabled]" id="footer_modified_enabled" <?php if($option['footer_modified_enabled'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="footer_content">
									<select id="footer_content" name="infuse-options[footer_content]">
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="site_width">
									<input class="textbox" id="site_width" type="text" size="3" maxlength="255" name="infuse-options[site_width]" value="<?php echo $option['site_width']; ?>" />px
                   				</label>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="left_sidebar_w">
									<input class="textbox" id="left_sidebar_w" type="text" size="3" maxlength="255" name="infuse-options[left_sidebar_w]" value="<?php echo $option['left_sidebar_w']; ?>" />px
                   				</label>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="right_sidebar_w">
									<input class="textbox" id="right_sidebar_w" type="text" size="3" maxlength="255" name="infuse-options[right_sidebar_w]" value="<?php echo $option['right_sidebar_w']; ?>" />px
                   				</label>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="rokbox_enabled"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[rokbox_enabled]" id="rokbox_enabled" <?php if($option['rokbox_enabled'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="rokbox_style">
									<select id="rokbox_style" name="infuse-options[rokbox_style]">
