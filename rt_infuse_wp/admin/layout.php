				...
				<tr>
					<td class="bigcol">
						<div class="scx<?php if(rok_isIE(6)) { echo ' ie6margin'; } ?>">
							<input id="scx" type="radio" <?php if ($option['layout_front'] == "s-c-x") : ?>checked="checked"<?php endif; ?> value="s-c-x" name="infuse-options[layout_front]"/>
						...
						<div class="xcs<?php if(rok_isIE(6)) { echo ' ie6margin'; } ?>">
							<input id="xcs" type="radio" <?php if ($option['layout_front'] == "x-c-s") : ?>checked="checked"<?php endif; ?> value="x-c-s" name="infuse-options[layout_front]"/>
						...
						<div class="scs<?php if(rok_isIE(6)) { echo ' ie6margin'; } ?>">
							<input id="scs" type="radio" <?php if ($option['layout_front'] == "s-c-s") : ?>checked="checked"<?php endif; ?> value="s-c-s" name="infuse-options[layout_front]"/>
						...
						<div class="xcx<?php if(rok_isIE(6)) { echo ' ie6margin'; } ?>">
							<input id="xcx" type="radio" <?php if ($option['layout_front'] == "x-c-x") : ?>checked="checked"<?php endif; ?> value="x-c-x" name="infuse-options[layout_front]"/>
				...
				<tr>
					<td class="bigcol">
						<div class="sub-scx<?php if(rok_isIE(6)) { echo ' ie6margin'; } ?>">
							<input id="sub-scx" type="radio" <?php if ($option['layout_subpage'] == "s-c-x") : ?>checked="checked"<?php endif; ?> value="s-c-x" name="infuse-options[layout_subpage]"/>
						...
						<div class="sub-xcs<?php if(rok_isIE(6)) { echo ' ie6margin'; } ?>">
							<input id="sub-xcs" type="radio" <?php if ($option['layout_subpage'] == "x-c-s") : ?>checked="checked"<?php endif; ?> value="x-c-s" name="infuse-options[layout_subpage]"/>
						...
						<div class="sub-scs<?php if(rok_isIE(6)) { echo ' ie6margin'; } ?>">
							<input id="sub-scs" type="radio" <?php if ($option['layout_subpage'] == "s-c-s") : ?>checked="checked"<?php endif; ?> value="s-c-s" name="infuse-options[layout_subpage]"/>
						...
						<div class="sub-xcx<?php if(rok_isIE(6)) { echo ' ie6margin'; } ?>">
							<input id="sub-xcx" type="radio" <?php if ($option['layout_subpage'] == "x-c-x") : ?>checked="checked"<?php endif; ?> value="x-c-x" name="infuse-options[layout_subpage]"/>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="left_front_side_file">
									<input class="textbox" id="left_front_side_file" type="text" size="16" maxlength="255" name="infuse-options[left_front_side_file]" value="<?php echo $option['left_front_side_file']; ?>" />
                   				</label>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="sidebar_left_front_authors"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[sidebar_left_front_authors]" id="sidebar_left_front_authors" <?php if($option['sidebar_left_front_authors'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="sidebar_left_front_authors_exadmin"><?php } ?><input type="checkbox" value="1" class="checkbox" name="infuse-options[sidebar_left_front_authors_exadmin]" id="sidebar_left_front_authors_exadmin" <?php if($option['sidebar_left_front_authors_exadmin'] == '1') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="sidebar_left_front_authors_fullname"><?php } ?><input type="checkbox" value="1" class="checkbox" name="infuse-options[sidebar_left_front_authors_fullname]" id="sidebar_left_front_authors_fullname" <?php if($option['sidebar_left_front_authors_fullname'] == '1') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="sidebar_left_front_blogroll"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[sidebar_left_front_blogroll]" id="sidebar_left_front_blogroll" <?php if($option['sidebar_left_front_blogroll'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="sidebar_left_front_blogroll_order">
									<select id="sidebar_left_front_blogroll_order" name="infuse-options[sidebar_left_front_blogroll_order]">
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="sidebar_left_front_blogroll_limit">
									<input class="textbox" id="sidebar_left_front_blogroll_limit" type="text" size="3" maxlength="255" name="infuse-options[sidebar_left_front_blogroll_limit]" value="<?php echo $option['sidebar_left_front_blogroll_limit']; ?>" />
                   				</label>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="sidebar_left_front_blogroll_categorize">
									<select id="sidebar_left_front_blogroll_categorize" name="infuse-options[sidebar_left_front_blogroll_categorize]" style="width: 100px !important;">
				...
				<tr>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="sidebar_left_front_blogroll_category">
									<input class="textbox" id="sidebar_left_front_blogroll_category" type="text" size="3" maxlength="255" name="infuse-options[sidebar_left_front_blogroll_category]" value="<?php echo $option['sidebar_left_front_blogroll_category']; ?>" />
                   				</label>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="sidebar_left_front_meta"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[sidebar_left_front_meta]" id="sidebar_left_front_meta" <?php if($option['sidebar_left_front_meta'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="right_front_side_file">
									<input class="textbox" id="right_front_side_file" type="text" size="16" maxlength="255" name="infuse-options[right_front_side_file]" value="<?php echo $option['right_front_side_file']; ?>" />
                   				</label>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="sidebar_right_front_categories"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[sidebar_right_front_categories]" id="sidebar_right_front_categories" <?php if($option['sidebar_right_front_categories'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="sidebar_right_front_categories_empty"><?php } ?><input type="checkbox" value="1" class="checkbox" name="infuse-options[sidebar_right_front_categories_empty]" id="sidebar_right_front_categories_empty" <?php if($option['sidebar_right_front_categories_empty'] == '1') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
						...
						<div class="paramfield">
							...
							<div class="paramcheck stubborn">
								<label class="sidebar_right_front_categories_order">
									<select id="sidebar_right_front_categories_order" name="infuse-options[sidebar_right_front_categories_order]">
				...
				<tr>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="sidebar_right_front_categories_exclude">
									<input class="textbox" id="sidebar_right_front_categories_exclude" type="text" size="10" maxlength="255" name="infuse-options[sidebar_right_front_categories_exclude]" value="<?php echo $option['sidebar_right_front_categories_exclude']; ?>" />
                   				</label>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="sidebar_right_front_archives"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[sidebar_right_front_archives]" id="sidebar_right_front_archives" <?php if($option['sidebar_right_front_archives'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="sidebar_right_front_archives_type">
									<select id="sidebar_right_front_archives_type" name="infuse-options[sidebar_right_front_archives_type]">
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="sidebar_right_front_archives_limit">
									<input class="textbox" id="sidebar_right_front_archives_limit" type="text" size="3" maxlength="255" name="infuse-options[sidebar_right_front_archives_limit]" value="<?php echo $option['sidebar_right_front_archives_limit']; ?>" />
                   				</label>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="sidebar_right_front_tags"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[sidebar_right_front_tags]" id="sidebar_right_front_tags" <?php if($option['sidebar_right_front_tags'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="sidebar_right_front_tags_order">
									<select id="sidebar_right_front_tags_order" name="infuse-options[sidebar_right_front_tags_order]">
				...
				<tr>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="left_sub_side_file">
									<input class="textbox" id="left_sub_side_file" type="text" size="16" maxlength="255" name="infuse-options[left_sub_side_file]" value="<?php echo $option['left_sub_side_file']; ?>" />
                   				</label>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="sidebar_left_sub_categories"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[sidebar_left_sub_categories]" id="sidebar_left_sub_categories" <?php if($option['sidebar_left_sub_categories'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="sidebar_left_sub_categories_empty"><?php } ?><input type="checkbox" value="1" class="checkbox" name="infuse-options[sidebar_left_sub_categories_empty]" id="sidebar_left_sub_categories_empty" <?php if($option['sidebar_left_sub_categories_empty'] == '1') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
						...
						<div class="paramfield">
							...
							<div class="paramcheck stubborn">
								<label class="sidebar_left_sub_categories_order">
									<select id="sidebar_left_sub_categories_order" name="infuse-options[sidebar_left_sub_categories_order]">
				...
				<tr>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="sidebar_left_sub_categories_exclude">
									<input class="textbox" id="sidebar_left_sub_categories_exclude" type="text" size="10" maxlength="255" name="infuse-options[sidebar_left_sub_categories_exclude]" value="<?php echo $option['sidebar_left_sub_categories_exclude']; ?>" />
                   				</label>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="sidebar_left_sub_archives"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[sidebar_left_sub_archives]" id="sidebar_left_sub_archives" <?php if($option['sidebar_left_sub_archives'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="sidebar_left_sub_archives_type">
									<select id="sidebar_left_sub_archives_type" name="infuse-options[sidebar_left_sub_archives_type]">
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="sidebar_left_sub_archives_limit">
									<input class="textbox" id="sidebar_left_sub_archives_limit" type="text" size="3" maxlength="255" name="infuse-options[sidebar_left_sub_archives_limit]" value="<?php echo $option['sidebar_left_sub_archives_limit']; ?>" />
                   				</label>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="sidebar_left_sub_tags"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[sidebar_left_sub_tags]" id="sidebar_left_sub_tags" <?php if($option['sidebar_left_sub_tags'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="sidebar_left_sub_tags_order">
									<select id="sidebar_left_sub_tags_order" name="infuse-options[sidebar_left_sub_tags_order]">
				...
				<tr>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="right_sub_side_file">
									<input class="textbox" id="right_sub_side_file" type="text" size="16" maxlength="255" name="infuse-options[right_sub_side_file]" value="<?php echo $option['right_sub_side_file']; ?>" />
                   				</label>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="sidebar_right_sub_authors"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[sidebar_right_sub_authors]" id="sidebar_right_sub_authors" <?php if($option['sidebar_right_sub_authors'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="sidebar_right_sub_authors_exadmin"><?php } ?><input type="checkbox" value="1" class="checkbox" name="infuse-options[sidebar_right_sub_authors_exadmin]" id="sidebar_right_sub_authors_exadmin" <?php if($option['sidebar_right_sub_authors_exadmin'] == '1') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="sidebar_right_sub_authors_fullname"><?php } ?><input type="checkbox" value="1" class="checkbox" name="infuse-options[sidebar_right_sub_authors_fullname]" id="sidebar_right_sub_authors_fullname" <?php if($option['sidebar_right_sub_authors_fullname'] == '1') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="sidebar_right_sub_blogroll"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[sidebar_right_sub_blogroll]" id="sidebar_right_sub_blogroll" <?php if($option['sidebar_right_sub_blogroll'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="sidebar_right_sub_blogroll_order">
									<select id="sidebar_right_sub_blogroll_order" name="infuse-options[sidebar_right_sub_blogroll_order]">
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="sidebar_right_sub_blogroll_limit">
									<input class="textbox" id="sidebar_right_sub_blogroll_limit" type="text" size="3" maxlength="255" name="infuse-options[sidebar_right_sub_blogroll_limit]" value="<?php echo $option['sidebar_right_sub_blogroll_limit']; ?>" />
                   				</label>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="sidebar_right_sub_blogroll_categorize">
									<select id="sidebar_right_sub_blogroll_categorize" name="infuse-options[sidebar_right_sub_blogroll_categorize]" style="width: 100px !important;">
				...
				<tr>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="sidebar_right_sub_blogroll_category">
									<input class="textbox" id="sidebar_right_sub_blogroll_category" type="text" size="3" maxlength="255" name="infuse-options[sidebar_right_sub_blogroll_category]" value="<?php echo $option['sidebar_right_sub_blogroll_category']; ?>" />
                   				</label>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="sidebar_right_sub_meta"><?php } ?><input type="checkbox" value="true" class="checkbox" name="infuse-options[sidebar_right_sub_meta]" id="sidebar_right_sub_meta" <?php if($option['sidebar_right_sub_meta'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
