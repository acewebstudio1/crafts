...
?>
	...
	<script type="text/javascript">
		...
		window.addEvent('domready', function() {
			...
			$('preset_style').empty();
			stylesList.set('style1', ['style1', 'full', 'infuse']);
			stylesList.set('style2', ['style2', 'full', 'optima']);
			stylesList.set('style3', ['style3', 'full', 'helvetica']);
			stylesList.set('style4', ['style4', 'full', 'georgia']);
			stylesList.set('style5', ['style5', 'full', 'continuum']);
			stylesList.set('style6', ['style6', 'full', 'geneva']);
		});
		...
		/* START_DEBUG ONLY */
			var debug_only = function() {
				...
				var tr = new Element('tr').inject($('font_face').getParent().getParent(), 'after');
					...
					<div id="top">
						...
						<div id="rt-top-m" class="png">
							...
							<ul class="additional-button">
								<li><a href="http://www.rockettheme.com/forum/index.php?f=340&amp;rb_v=viewforum" target="_blank" title="FORUMS" class="roktips topforums"><span class="rthide">Forums</span></a></li>
							</ul>
