<?php
/*
Template Name: Our Store Category Page
 */
get_header(); ?>
...
//xProductBrowser("categoriesPerRow=3","views=grid(3,3) list(10) table(20)","categoryView=grid","searchView=list","style=","defaultCategoryId=<?php echo $category_id; ?>");
                                                ...
                                                <?php
                                                    ...
                                                    $ch = curl_init();
                                                    $url = 'http://app.ecwid.com/api/v1/617007/categories?parent=0';
                                                ...
                                                <?php
                                                    foreach($catArray as $key=>$catObj):
                                                        // checking if the category is present in WP
                                                        ...
                                                        //echo $table_values;
                                                        $sql = "select * from " . $table_values . " where field_name = 'Ecwid Category ID' and field_value = " . $catObj->id;
                                                        $res = $wpdb->get_row($sql);
                                                        //print_r($res);
                                                        $wpCatId = $res->term_id;
                                                        if((int)$wpCatId) {
                                                            $wpCatObj = get_category($wpCatId);
                                                            //print_r($wpCatObj);
                                                            $catObj->url = get_category_link($wpCatId);
                                                        }
