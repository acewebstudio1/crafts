...
class RokStoriesWidget extends WP_Widget {
    ...
    function widget($args, $instance){
 		...
 		$rokstories_layout = empty($instance['rokstories_layout']) ? 'layout2' : $instance['rokstories_layout'];
 		...
 		$rokstories_contentpos = empty($instance['rokstories_contentpos']) ? 'right' : $instance['rokstories_contentpos'];
 		...
 		$rokstories_autoplay = empty($instance['rokstories_autoplay']) ? '1' : $instance['rokstories_autoplay'];
 		...
 		$rokstories_imgw = empty($instance['rokstories_imgw']) ? '460' : $instance['rokstories_imgw'];
 		$rokstories_imgh = empty($instance['rokstories_imgh']) ? '226' : $instance['rokstories_imgh'];
    ...
    function form($instance){
  		...
  		$instance = wp_parse_args( (array) $instance, array('title'=>'', 'rokstories_layout'=>'layout2', 'rokstories_display'=>'content', 'rokstories_cat'=>'1', 'rokstories_artcount'=>'3', 'rokstories_order'=>'date', 'rokstories_contentpos'=>'right', 'rokstories_title'=>'true', 'rokstories_date'=>'false', 'rokstories_content'=>'true', 'rokstories_readmore'=>'true', 'rokstories_thumbbox'=>'auto', 'rokstories_firstart'=>'0', 'rokstories_thumbopa'=>'1', 'rokstories_interact'=>'click', 'rokstories_autoplay'=>'1', 'rokstories_autoplaydelay'=>'5000', 'rokstories_labeltitle'=>'false', 'rokstories_preview'=>'0', 'rokstories_fixedpreview'=>'1', 'rokstories_linklabel'=>'false', 'rokstories_linkimage'=>'0', 'rokstories_arrows'=>'false', 'rokstories_imgw'=>'460', 'rokstories_imgh'=>'226', 'rokstories_thumbw'=>'90', 'rokstories_thumbh'=>'41' ) );
		...
		<label for="<?php echo $this->get_field_id('rokstories_arrows'); ?>1"><?php _re('Yes'); ?></label>&nbsp;&nbsp;
		...
		<label for="<?php echo $this->get_field_id('rokstories_arrows'); ?>0"><?php _re('No'); ?></label>
		<br /><br />
